...
class _QuizPlayPageState extends State<QuizPlayPage> {
  ...
  void _cekJawabanLaluSelesai() {
    ...
    Navigator.pushReplacement(
      context, 
      MaterialPageRoute(builder: (_) => QuizResultPage(
        score: finalScore, 
  ...
  Widget build(BuildContext context) {
    if (widget.questions.isEmpty) return const Scaffold(body: Center(child: Text("Tidak ada soal")));
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text("Soal ${_currentIndex + 1} / ${widget.questions.length}", 
                      style: GoogleFonts.quicksand(fontWeight: FontWeight.bold, color: Colors.grey.shade600)),
                    Text("${(_score)} Benar", 
                      style: GoogleFonts.quicksand(fontWeight: FontWeight.bold, color: accentOrange)),
                  ],
                ),
                ...
                Container(
                  ...
                  child: Text(
                    currentQ.question,
                    style: GoogleFonts.nunito(fontSize: 20, fontWeight: FontWeight.w800, color: darkBlueText),
                ...
                ElevatedButton(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.nunito(
                      ...
                      color: _selectedAnswer == null ? Colors.grey.shade600 : Colors.white
                    )
                  ),
                )
              ],
